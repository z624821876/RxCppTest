...
public:
    ...
    */
     ...
     */
    template<class... AN>
    auto throttled(AN&&... an) const
    /// \cond SHOW_SERVICE_MEMBERS
    -> decltype(observable_member(throttled_tag{}, *(this_type*)nullptr, std::forward<AN>(an)...))
    /// \endcond
    {
        return  observable_member(throttled_tag{},                *this, std::forward<AN>(an)...);
    }
